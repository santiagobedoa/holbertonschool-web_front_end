# [Responsive design](https://intranet.hbtn.io/projects/600)

<html>
<div class="panel panel-default" id="project-description">
 <div class="panel-body">
  <p>
   <img alt="" loading="lazy" src="https://s3.eu-west-3.amazonaws.com/hbtn.intranet/uploads/medias/2019/12/4fe027a0c298339cb4cb.jpg?X-Amz-Algorithm=AWS4-HMAC-SHA256&amp;X-Amz-Credential=AKIA4MYA5JM5DUTZGMZG%2F20221219%2Feu-west-3%2Fs3%2Faws4_request&amp;X-Amz-Date=20221219T210913Z&amp;X-Amz-Expires=86400&amp;X-Amz-SignedHeaders=host&amp;X-Amz-Signature=5e8f733908bd340d1177e85057969aa922b4eff5de860d135a1c08793d416395" style=""/>
  </p>
  <h2>
   Resources
  </h2>
  ...
  <p>
   <img alt="" loading="lazy" src="https://s3.eu-west-3.amazonaws.com/hbtn.intranet/uploads/medias/2020/4/a1f906a6a39eba8cb2f3d2877abc9ea84be51d9d.png?X-Amz-Algorithm=AWS4-HMAC-SHA256&amp;X-Amz-Credential=AKIA4MYA5JM5DUTZGMZG%2F20221219%2Feu-west-3%2Fs3%2Faws4_request&amp;X-Amz-Date=20221219T210913Z&amp;X-Amz-Expires=86400&amp;X-Amz-SignedHeaders=host&amp;X-Amz-Signature=e697241f7e93e18c86b6b893d40e59221a1adcb7f6a070be05e2f3d52312e83d" style=""/>
  </p>
  <h2>
   Starter files
  </h2>
  ...
  <p>
   <textarea cols="81" readonly="" rows="21">
&lt;!DOCTYPE html&gt;
<html dir="ltr" lang="en">
  <head>
    ...
    <link href="00-styles.css" rel="stylesheet"/>
  </head>
  <body>
    &lt;!– Header –&gt;
    <header class="header" data-section-theme="dark">
      <div class="container">
        ...
        <div class="header-logo">
          <a href="#">
            <img alt="Techium logo" height="40" src="images/logo-white.png" width="160"/>
          </a>
        </div>
            ...
            <li class="nav-item">
              <a class="nav-link" href="#contact">Contact</a>
                ...
                <form action="#" class="form-search" method="post">
                  <input aria-label="Search through site content" id="search-input" name="q" placeholder="Search..." type="search"/>
                  <button class="search-button">
                    <svg class="search-icon" height="20" viewbox="0 0 512 512" width="20" xmlns="http://www.w3.org/2000/svg">
                      <title>
                        Search icon
                      </title>
    ...
    <main>
      ...
      &lt;!– Works section –&gt;
      <section class="section section-works" data-section-theme="dark" id="works">
        <div class="container">
          <header class="section-header">
            ...
            <ul class="row">
                ...
                <article class="card-work">
                  <div class="card-outer">
                    <div class="card-image">
                      <img alt="" src="images/pic-work-01.jpg"/>
                    </div>
              ...
              <li class="col-1-3">
                <article class="card-work">
                  <div class="card-outer">
                    <div class="card-image">
                      <img alt="" src="images/pic-work-02.jpg"/>
                    </div>
                    <div class="card-inner">
                      <h3 class="card-title"><a href="#">Web Development</a></h3>
                    </div>
              ...
              <li class="col-1-3">
                <article class="card-work">
                  <div class="card-outer">
                    <div class="card-image">
                      <img alt="" src="images/pic-work-03.jpg"/>
                    </div>
                    <div class="card-inner">
      ...
      <section class="section section-about-us" id="about">
        <div class="container">
          ...
          <div class="section-body">
            <div class="row">
              <div class="col-1-2">
                <img alt="" height="460" src="images/pic-about-01.jpg" width="460"/>
              </div>
              <div class="col-1-2">
                <h3>Who are we</h3>
      ...
      &lt;!– Latest news section –&gt;
      <section class="section section-latest-news" id="latest_news">
        <div class="container">
          <header class="section-header">
            ...
            <ul class="row">
              <li class="col-1-3">
                <article class="card-blog">
                  <div>
                    <img alt="" height="305" src="images/pic-article-01.jpg" width="305"/>
                  </div>
              ...
              <li class="col-1-3">
                <article class="card-blog">
                  <div>
                    <img alt="" height="305" src="images/pic-article-02.jpg" width="305"/>
                  </div>
              ...
              <li class="col-1-3">
                <article class="card-blog">
                  <div>
                    <img alt="" height="305" src="images/pic-article-03.jpg" width="305"/>
                  </div>
            ...
            <ul class="row">
              <li class="col-1-3">
                <article class="card-testimonial">
                  <img alt="Yuri Y. avatar" class="card-avatar" height="100" src="images/pic-person-01.jpg" width="100"/>
              ...
              <li class="col-1-3">
                <article class="card-testimonial">
                  <img alt="Dorrie S. avatar" class="card-avatar" height="100" src="images/pic-person-02.jpg" width="100"/>
                  <blockquote class="card-quote">
              ...
              <li class="col-1-3">
                <article class="card-testimonial">
                  <img alt="Sven H. avatar" class="card-avatar" height="100" src="images/pic-person-03.jpg" width="100"/>
                  <blockquote class="card-quote">
          ...
          <div class="col-1-2">
            <ul class="social nav">
              <li class="social-item nav-item">
                <a class="social-link" href="https://www.facebook.com/HolbertonSchool/">
              ...
              <li class="social-item nav-item">
                <a class="social-link" href="https://twitter.com/holbertonschool">
                  <svg height="25" viewbox="0 0 24 24" width="25" xmlns="http://www.w3.org/2000/svg">
                    <title>
                      Twitter icon
                    </title>
              ...
              <li class="social-item nav-item">
                <a class="social-link" href="https://www.instagram.com/holbertonschool/">
                  <svg height="25" viewbox="0 0 24 24" width="25" xmlns="http://www.w3.org/2000/svg">
                    <title>
                      Instagram icon
                    </title>
        ...
        <div class="row">
          ...
          <div class="col-1-2">
            <ul class="footer-nav nav">
              ...
              <li class="footer-nav-item nav-item">
                <a class="footer-nav-link" href="#">Cookie Policy</a>
              </li>
            </ul>
          </div>
        </div>
...
/* Variables
  ...
  *, *:before, *:after {
  ...
  <p>
   ...
   <a href="https://s3.eu-west-3.amazonaws.com/hbtn.intranet/uploads/misc/2020/2/2621c6fd51a58e1d1d5c.zip?X-Amz-Algorithm=AWS4-HMAC-SHA256&amp;X-Amz-Credential=AKIA4MYA5JM5DUTZGMZG%2F20221219%2Feu-west-3%2Fs3%2Faws4_request&amp;X-Amz-Date=20221219T210913Z&amp;X-Amz-Expires=345600&amp;X-Amz-SignedHeaders=host&amp;X-Amz-Signature=96e89344806598e393ca40d274db2f4af0c542bd4920f1cf1780d8d0f89feabe" target="_blank" title="archive.zip">
    archive.zip
   </a>
  </p>
 </div>
